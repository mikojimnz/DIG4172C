...
function Ao(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=bb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
F("PL_ATT")&&bp.dispose();for(var a=0,b=Uo.length;a<b;a++)th.aa(Uo[a]);Uo.length=0;So("//static.doubleclick.net/instream/ad_status.js");Vo=!1;M("DCLKSTAT",0);(0,Vd)(iq,hq);gq&&(gq.removeEventListener("onVideoDataChange",jq),gq.destroy())});
